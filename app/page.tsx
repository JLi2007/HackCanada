...
export default function Home() {
  return (
    <div className="relative">
      <img src="/press_space_bar.svg" className="absolute top-20 left-200" width="20%"></img>
      <img src="/hover_over_cards.svg" className="absolute bottom-10 left-170" width="20%"></img>
      ...
      <div className="flex flex-col items-center justify-left w-[50%] gap-8">
        <h1 className="flex items-center justify-center text-6xl h-[10%] w-[75%] text-black font-extrabold text-left animate-gradient-x">
